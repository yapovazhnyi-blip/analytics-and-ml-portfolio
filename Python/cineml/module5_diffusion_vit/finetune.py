    ...
    def __init__(self, data_dir: Path, split: str = "train"):
        ...
        for label_idx, genre in enumerate(GENRES):
            ...
            if not genre_dir.exists():
                continue
            for img_path in genre_dir.glob("*.jpg"):
...
def finetune_vit(
    ...
    train_ds = PosterDataset(data_dir, split="train")
    val_ds = PosterDataset(data_dir, split="val")
...
if __name__ == "__main__":
    ...
    finetune_vit(args.data_dir, args.output_dir, args.epochs)
